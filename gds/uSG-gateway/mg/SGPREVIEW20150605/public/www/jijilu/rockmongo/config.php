...
*/
$MONGO["servers"][$i]["mongo_name"] = "rhosouth007";//mongo server name
$MONGO["servers"][$i]["mongo_host"] = "10.161.149.225";//mongo host
$MONGO["servers"][$i]["mongo_port"] = "10001";//mongo port
...
$MONGO["servers"][$i]["mongo_port"] = "10001";
