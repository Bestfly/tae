...
static ngx_int_t ngx_http_variable_exproy_addr(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data);
static ngx_int_t ngx_http_variable_exproy_port(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data);
...
static ngx_http_variable_t  ngx_http_core_variables[] = {
	...
	{ ngx_string("exproy_addr"), NULL, ngx_http_variable_exproy_addr, 0, 0, 0 },
	
	{ ngx_string("exproy_port"), NULL, ngx_http_variable_exproy_port, 0, 0, 0 },
...
static ngx_int_t
ngx_http_variable_exproy_addr(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
    v->len = 13;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) "182.92.239.16";

    return NGX_OK;
}

static ngx_int_t
ngx_http_variable_exproy_port(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
